 ...
 * Overrides default WooCommerce variable product form
 *
 * Place this file in your child theme:
...
<form class="variations_form cart" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data' data-product_id="<?php echo absint( $product->get_id() ); ?>" data-product_variations='<?php echo $variations_attr; ?>'>
	...
	<?php else : ?>
		<div id="custom-variation-ui">
			<div class="velicina-group">
				<p><strong>Veličina:</strong></p>
				<!-- JS will render buttons here -->
			</div>

			<div class="trajanje-group">
				<p><strong>Trajanje:</strong></p>
				<div id="trajanje-options"></div>
			</div>
		</div>
